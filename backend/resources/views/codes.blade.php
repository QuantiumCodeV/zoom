      ...
      window.hs_config = {
        ...
        skipFilesFromBundle: {
          ...
          build: [
            ...
            "/assets/vendor/node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js",
            "{{  asset("assets/js/demo.js") }}",
          ],
        },
        ...
        buildFolder: "",
        replacePathsToCDN: {},
        directoryNames: { src: "", dist: "./dist", build: "./build" },
        fileNames: {
      ...
      <div class="content container-fluid">
        ...
        <div class="card">
          ...
          <div class="table-responsive datatable-custom position-relative">
              ...
              @foreach($codes as $code)
                <tr>
                  ...
                  <td>
                    <button
                      type="button"
                      class="btn {{ $code->status == "active" ? "btn-danger" : "btn-outline-danger" }} btn-sm delete-code"
                      data-code="{{ $code->code }}"
                    >
            ...
            <script>
              document.querySelectorAll('.delete-code').forEach(function(item) {
                item.addEventListener('click', function() {
                  $.ajax({
                    url: "{{ route('code.delete') }}",
                    method: 'POST',
                    data: {
