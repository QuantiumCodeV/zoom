...
@endif</span
      ...
      <div class="row">
        <div class="col-sm-6  mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Сгенерировано:</h6>

              <div class="row align-items-center gx-2 mb-1">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ $count }}</h2>
                </div>
        ...
        <div class="col-sm-6 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Активировано</h6>

              <div class="row align-items-center gx-2 mb-1">
                <div class="col-6">
                  <h2 class="card-title text-inherit"> {{   $totalActivations  }} </h2>
                </div>
        ...
        <div class="col-sm-6  mb-3 mb-lg-5">
          <!-- Card -->
          <a class="card card-hover-shadow h-100" href="{{ route("codes") }} ">
            <div class="card-body">
              <h2 >Создать код</h2>              
            </div>
          </a>
  ...
  <div class="modal fade" id="inassetUserModal" tabindex="-1" aria-labelledby="inassetUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="inassetUserModalLabel">Inasset users</h4>
          ...
          <div class="mb-4">
            <div class="input-group mb-2 mb-sm-0">
              ...
              <div class="input-group-append input-group-append-last-sm-down-none">
                ...
                <a class="btn btn-primary d-none d-sm-inline-block" href="javascript:;">Inasset</a>
              </div>
            </div>

            <a class="btn btn-primary w-100 d-sm-none" href="javascript:;">Inasset</a>
          </div>
          <!-- End Form -->

          <div class="row">
            <h5 class="col modal-title">Inasset users</h5>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-sm-auto">
                      ...
                      <div class="tom-select-custom tom-select-custom-sm-end">
                        <select class="js-select form-select form-select-borderless tom-select-custom-form-select-inasset-user tom-select-form-select-ps-0" autocomplete="off" data-hs-tom-select-options='{
                                  "searchInDropdown": false,
                                  "hideSearch": true,
                                  "dropdownWidth": "11rem"
                                }'>
        ...
        <div class="modal-footer">
          <div class="row align-items-center flex-grow-1 mx-n2">
            <div class="col-sm-9 mb-2 mb-sm-0">
              <input type="hidden" id="inassetUserPublicClipboard" value="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/">
            ...
            <div class="col-sm-3 text-sm-end">
              <a class="js-clipboard btn btn-white btn-sm text-nowrap" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy to clipboard!" data-hs-clipboard-options='{
                  "type": "tooltip",
                  "successText": "Copied!",
                  "contentTarget": "#inassetUserPublicClipboard",
                  "container": "#inassetUserModal"
                 }'>
