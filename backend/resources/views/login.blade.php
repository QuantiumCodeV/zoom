    ...
    <div class="container py-5 py-sm-7">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form class="" action="{{route("user.login")}}" method="POST" novalidate>
            @csrf
              <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Sign in</h1>
                  <p>Don't have an account yet? <a class="link" href="{{route("signup") }}">Sign up here</a></p>
                </div>
              </div>

              <!-- Form -->
              <div class="mb-4">
                <label class="form-label" for="signinSrEmail">Your login</label>
                <input type="text" class="form-control form-control-lg" name="login" id="signinSrEmail" tabindex="1" placeholder="login" aria-label="login" required>
