        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            ...
            <form class="js-validate needs-validation" novalidate>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label class="form-label" for="signupSrEmail" >Your login</label>
                <input type="text" class="form-control form-control-lg" id="validate-input2" name="login" id="signupSrEmail" placeholder="login" aria-label="login" required>
                <span class="invalid-feedback" id="text_login">Please enter a valid login.</span>
              </div>
              <!-- End Form -->
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" id="validate-input" data-hs-validation-validate-class>
            ...
            $.ajax({
              ...
              error: function(response) {
                console.log('error')
                  ...
                  {
                    $("#validate-input2")[0].setCustomValidity('Invalid');
                    $("#text_login").text("Login has already token")
                    $("#validate-input2").change(function(){
                      $("#validate-input2")[0].setCustomValidity('');
                    })
                  }
