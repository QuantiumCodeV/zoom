  ...
  ; (function () {
    ...
    $.extend(SB, {
      ...
      hideHeader: function () {
        ...
        $('#content_container').removeClass('Zооm-newcontent')
      },
    ...
    $(function () {
      ...
      $('.dropdown-language').on('click', '.dropdown-menu a', function (ab) {
        ...
        if (aa.data('locale') != '') {
          ...
          var pageURL = 'https://' + location.hostname //		"https://Zооm.us"
